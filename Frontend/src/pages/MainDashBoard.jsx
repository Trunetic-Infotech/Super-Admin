    ...
    <div className="flex  w-full h-screen  ">
      ...
      >
        ...
        <div className="mb-auto mt-10 px-6">
          <button className="lg:px-7 lg:py-4 px-5 py-2 border-2 border-white rounded-2xl sm:text-sm md:text-sm lg:text-2xl hover:text-white hover:border-white">
            <LogOut className="w-6 h-5" />
          </button>
          <span className="ml-4 lg:text-2xl text-xl font-semibold">Logout</span>
        </div>
      </div>
